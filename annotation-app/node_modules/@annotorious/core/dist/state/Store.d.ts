...
export declare const createStore: <T extends Annotation>() => {
    ...
    all: () => T[];
    bulkAddAnnotations: (annotations: Partial<T>[], replace?: boolean, origin?: Origin) => void;
    bulkDeleteAnnotations: (annotationsOrIds: (T | string)[], origin?: Origin) => void;
    bulkDeleteBodies: (bodies: AnnotationBodyIdentifier[], origin?: Origin) => void;
    bulkUpdateAnnotations: (annotations: T[], origin?: Origin) => void;
    ...
    bulkUpsertAnnotations: (annotations: Partial<T>[], origin?: Origin) => void;
    ...
    syncAnnotations: (annotations: Partial<T>[], origin?: Origin) => void;
    unobserve: (onChange: {
        (event: StoreChangeEvent<T>): void;
    }) => void;
    ...
    upsertAnnotation: (annotation: T, origin?: Origin) => void;
};
export {};
